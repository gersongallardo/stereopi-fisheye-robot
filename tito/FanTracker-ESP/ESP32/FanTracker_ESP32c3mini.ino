...
// ===== WiFi =====
//const char* SSID = "gersongallard";
//const char* PASS = "asas1212";
//const char* SSID = "losrobles800";
//const char* PASS = "losrobles800";
const char* SSID = "innovex_test";
const char* PASS = "Radar_innovex!";
WiFiServer server(3333);
WiFiClient client;

// ===== NTP para sincronizar hora =====
const char* ntpServer = "pool.ntp.org";
const long gmtOffset_sec = -14400;  // Chile: UTC-4
...
const float BATTERY_CALIBRATION = 0.865; // Ajuste según multímetro (16.12V real vs 18.63V leído)
...
void processAutoMission() {
  ...
  if (now >= nextAutoMissionMs) {
    nextAutoMissionMs = now + autoMissionIntervalMs;
