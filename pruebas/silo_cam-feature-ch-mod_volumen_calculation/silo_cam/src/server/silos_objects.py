...
abtao_1_1 = silo_abtao(silo_id='1', z_vacio = -3.63, volumen_maximo = 75,
                       traslacion = [0.3, -0.1, 0], rotacion = [0, 0, 0])

abtao_2_1 = silo_abtao(silo_id='2', z_vacio = -3.63, volumen_maximo = 75,
                       traslacion = [-0.35, -0.1, 0], rotacion = [0, 0, 0])

abtao_3_1 = silo_abtao(silo_id='3', z_vacio = -3.63, volumen_maximo = 75,
                       traslacion = [0.1, -0.3, 0], rotacion = [0, 0, 0])

abtao_4_1 = silo_abtao(silo_id='4', z_vacio = -3.63, volumen_maximo = 75,
