...
def graficar_volumen(df, silo):
    ...
    fig.update_layout(
        title=f'Volumen de pellet en el silo {silo.silo} {silo.ubicacion} usando valor promedio',
        title_x=0.5,
...
df_media = filtro_interpolacion_volumen(df_media, window_size=3, n_sigmas=2)
