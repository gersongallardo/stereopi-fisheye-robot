...
cubo.apply_translation((silo.ancho / 2, silo.largo / 2, altura_prisma + silo.alto_piramide + silo.alto_ortoedro / 2))
...
prisma.apply_translation([
    silo.ancho / 2,                 # centrar en X
    silo.largo / 2,                 # centrar en Y
...
cubo_mitad.apply_translation((ancho / 2, largo / 2, (silo.alto_piramide+altura_prisma)/2))  # base en z=0
