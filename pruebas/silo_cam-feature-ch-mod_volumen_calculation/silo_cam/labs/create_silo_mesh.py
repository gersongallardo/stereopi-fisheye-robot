...
cubo.apply_translation((0, 0, silo.alto_piramide + silo.alto_ortoedro / 2))
...
grid = create_grid(size=5, step=1)
...
if silo.silo_mitad:
    cubo_mitad.apply_translation((0, -largo/2, silo.alto_piramide/2))  # base en z=0
else:
    cubo_mitad.apply_translation((0, 0, silo.alto_piramide/2))  # base en z=0
...
print(f"📐 Volumen del complemento de la base: {volumen_complemento_base:.4f} unidades cúbicas")

volumen_silo = silo_final.volume
print(f"📐 Volumen del silo: {volumen_silo:.4f} unidades cúbicas")