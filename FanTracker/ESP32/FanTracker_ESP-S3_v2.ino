...
const float BATTERY_CALIBRATION = 1.062; // Ajuste según multímetro
...
const unsigned long autoMissionStartDelayMs = 300000;
...
// ===== Filtros de sensor =====
const float PRESSURE_JUMP_MAX_MBAR = 500.0f;
...
void loop() {
  ...
  if (sleepPending && missionState == COMPLETED) {
